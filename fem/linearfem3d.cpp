...
LinearFEM3D::LinearFEM3D(Mesh *_mesh, Data *_data) :
FEM(_mesh, _data)
{
    strcpy(Type, "LinearFEM3D");
...
void LinearFEM3D::GetElementDOF(int i, Array<int> &ind)
{
  mesh->GetElementVertices(i, ind);
}
//==============================================================================

void LinearFEM3D::GetBdrElementDOF(int i, Array<int> &ind)
{
...
void LinearFEM3D::ComputeEllipticLocalSystem(int i, Array<int> &ind, Array<double *> &locmat)
{
...
void LinearFEM3D::ComputeReactionLocalSystem(int i, Array<int> &ind, Array<double *> &locmat)
{
  ;
}
...
void LinearFEM3D::ComputeForceLocalSystem(int i, Array<int> &ind, Array<double> &locrhs)
{
  Array<double> locdat(ind.Size());
  for (int j=0; j<ind.Size(); j++)
...
void LinearFEM3D::ProjectAFunction(double (*func)(Array<double> &), Vector &pval)
{
...
//=============================================================================
void  LinearFEM3D::ComputeNeumannLocalSystem(int i, Array<int> &ind, Array<double> &locrhs)
{
  Array<double> locdat(ind.Size());
  for (int j=0; j<ind.Size(); j++)
    {
...
void LinearFEM3D::SetDirichletBoundary(Array<bool *> &bdry_is_dirichlet, 
