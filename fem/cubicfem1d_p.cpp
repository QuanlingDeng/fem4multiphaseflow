...
CubicFEM1D_p::CubicFEM1D_p(Mesh_p *_mesh, Data *_data) :
FEM_p(_mesh, _data)
{
    strcpy(Type, "CubicFEM1D_p");
...
void CubicFEM1D_p::GetElementDOF(int i, Array<int> &ind)
{
  ind[0] = i;
...
void CubicFEM1D_p::ComputeEllipticLocalSystem(int i, Array<int> &ind, Array<double *> &locmat)
{
...
void CubicFEM1D_p::ComputeReactionLocalSystem(int i, Array<int> &ind, Array<double *> &locmat)
{
  ;
}
...
void CubicFEM1D_p::ComputeForceLocalSystem(int i, Array<int> &ind, Array<double> &locrhs)
{
