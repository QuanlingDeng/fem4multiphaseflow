...
CubicFVEM2D::CubicFVEM2D(Mesh *_mesh, Data *_data) :
FEM(_mesh, _data)
{
  strcpy(Type, "CubicFVEM2D");
  NumGlobalDOF = mesh->GetNV() + mesh->GetNEdges();
  NumLocalDOF = 10;
  rhs.SetSize(NumGlobalDOF);
  mat = new SparseMatrix(NumGlobalDOF, 50);
}

//============================================================================== 

void CubicFVEM2D::GetElementDOF(int i, Array<int> &ind)
{
...
void CubicFVEM2D::GetBdrElementDOF(int i, Array<int> &ind)
{
...
void CubicFVEM2D::ComputeEllipticLocalSystem(int i, Array<int> &ind, Array<double *> &locmat)
{
...
void CubicFVEM2D::ComputeReactionLocalSystem(int i, Array<int> &ind, Array<double *> &locmat)
{
  ;
}
...
void CubicFVEM2D::ComputeForceLocalSystem(int i, Array<int> &ind, Array<double> &locrhs)
{
  Array<double *> coord(mesh->GetDim());
...
void CubicFVEM2D::SetDirichletBoundary(Array<bool *> &bdry_is_dirichlet, 
...
void CubicFVEM2D::ProjectAFunction(double (*func)(Array<double> &), Vector &pval)
{// not right
