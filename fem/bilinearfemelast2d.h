#ifndef FILE_BILINEARFEMELAST2D
#define FILE_BILINEARFEMELAST2D

/*
Data type BiliniearFEMELAST2D
Author: Bradley McCaskill
*/

/// BilinearFEMELAST2D data type. 
class BilinearFEMELAST2D : public FEM
{
protected:
...
public:
  ...
  BilinearFEMELAST2D(Mesh *_mesh, Data *_data);
